...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_Screen.git', :tag => s.version.to_s }
...
#====================================================================
# 'h,m' 之间不能有空格
s.source_files = 'HR_Screen/Classes/**/*.{h,m}'


# 3.3:资源文件
#====================================================================
# 'HR_Screen' 为存储的 bundleName
#s.resource_bundles = {
#    'HR_Screen' => ['HR_Screen/**/*.{storyboard,xib,png,plist}']
#}
